...
// You can make your own logos at https://javl.github.io/image2cpp/
// Upload a 128 x 32 black and white image.
// Code output format: Plain
// Draw mode: Vertical - 1 bit per pixel
// Press Generate code and copy the output to here
